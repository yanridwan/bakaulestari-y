                                    ...
                                    <table id="example1" class="table table-bordered table-striped">
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td> <?php if(substr($file->gallery_gambar,-3) == "JPG") { ?><img
                                                        src="<?= base_url('upload/Gallery/') . $file->gallery_gambar ?>"
                                                        style="width:100px">
                                                    <?php } elseif(substr($file->gallery_gambar,-3) == "png") { ?><img
                                                        src="<?= base_url('upload/Gallery/') . $file->gallery_gambar ?>"
                                                        style="width:100px">
                                                    <?php } elseif(substr($file->gallery_gambar,-3) == "jpeg") { ?><img
                                                        src="<?= base_url('upload/Gallery/') . $file->gallery_gambar ?>"
                                                        style="width:100px">
                                                    <?php } elseif(substr($file->gallery_gambar,-3) == "mp4") { ?>
                                                    <video controls style="width: 50%; height: 150px;">
                                                        <source
                                                            src="<?= base_url('upload/Gallery/') . $file->gallery_gambar ?>"
                                                            type="video/webm" />
                                                        Browsermu tidak mendukung tag ini, upgrade donk!
                                                    </video>
                                                    <?php } elseif(substr($file->gallery_gambar,-3) == "3gp") { ?>
                                                    <video controls style="width: 50%; height: 150px;">
                                                        <source
                                                            src="<?= base_url('upload/Gallery/') . $file->gallery_gambar ?>"
                                                            type="video/webm" />
                                                ...
                                                <td>
                                                    <button type="button" class="btn btn-success btn-sm"
                                                        data-toggle="modal" data-target="#edit<?= $file->gallery_id ?>">
                                ...
                                <div class="modal-body">
                                    <div class="card-body">
                                        <div class="form-group">
                                            <label>Judul</label>
                                            <input type="text" class="form-control" name="judul"
                                                value="<?= $gall->gallery_nama?>" placeholder="Judul Gallery">
                                        </div>
                                        <div class="form-group">
                                            <div class="form-group">
                                                <label for="exampleInputFile">Gambar</label>
